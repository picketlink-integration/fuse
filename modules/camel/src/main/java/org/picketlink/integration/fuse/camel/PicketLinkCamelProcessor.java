...
public class PicketLinkCamelProcessor implements Processor{
    ...
    /**
     * {@link org.picketlink.Identity} is session scoped. If the message came with
     * an username that is different from what we are currently logged in, we would like
